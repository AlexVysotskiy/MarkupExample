...
<div class="main-promoCompetence promo">
    <div class="container-fluid">
        ...
        <div class="row promo-features">
            ...
            <div id="func-testing" class="col-md-4 item search redirect" data-redirect="<?php echo $baseLink; ?>/competence#func" onmousedown="javascript: location = '<?php echo $baseLink; ?>/competence#func';">
                <div class="icon">
